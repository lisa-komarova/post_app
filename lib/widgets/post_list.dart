...
///A widget that shows content according to the state of list of post
/// a list of posts when it's loaded successfully
/// circular indicator when the list is loading
/// or a snackbar when an error occurred
